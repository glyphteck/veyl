...
export function draftPayload(value) {
    ...
    return {
        ...
        pendingTransfersById: { ...input.pendingTransfersById },
        pendingTransferIds: [...input.pendingTransferIds],
...
export function normalizePayload(value) {
    ...
    return {
        ...
        pendingTransfersById: isObject(input.pendingTransfersById) ? input.pendingTransfersById : {},
        pendingTransferIds: Array.isArray(input.pendingTransferIds) ? input.pendingTransferIds.filter(Boolean) : [],
