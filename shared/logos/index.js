...
export const walletlogo = new URL('./wallet.png', import.meta.url).href;
export const walletdevlogo = new URL('./walletdev.png', import.meta.url).href;
export const wallettestlogo = new URL('./wallettest.png', import.meta.url).href;
