...
export const BOT_ACTION_TYPE_TRAFFIC_MSG = 'traffic-msg';
export const BOT_ACTION_TYPE_TRAFFIC_FUND = 'traffic-fund';
export const BOT_ACTION_TYPE_TRAFFIC_TX = 'traffic-tx';
