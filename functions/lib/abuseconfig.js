...
export const MEDIA_UPLOAD_URL_TTL_MS = 15 * MINUTE_MS;
export const MEDIA_CONTENT_TYPE = 'application/octet-stream';

export const MEDIA_UPLOAD_UID_MINUTE_LIMIT = 30;
export const MEDIA_UPLOAD_UID_HOUR_LIMIT = 240;
export const MEDIA_UPLOAD_UID_DAY_LIMIT = 1000;
...
export const mediaUploadLimitRules = (key) => [
    { name: 'media-upload-uid-minute', key, limit: MEDIA_UPLOAD_UID_MINUTE_LIMIT, windowMs: MINUTE_MS },
    { name: 'media-upload-uid-hour', key, limit: MEDIA_UPLOAD_UID_HOUR_LIMIT, windowMs: HOUR_MS },
    { name: 'media-upload-uid-day', key, limit: MEDIA_UPLOAD_UID_DAY_LIMIT, windowMs: DAY_MS },
];
