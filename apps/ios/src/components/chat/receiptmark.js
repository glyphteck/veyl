...
const RECEIPT_MARK_WIDTH = RECEIPT_MARK_SIZE + 4;
...
export default function ReceiptMark({ show, source, bot, frozen = false }) {
    ...
    return (
        <Animated.View pointerEvents="none" style={[{ alignSelf: 'flex-end', width: RECEIPT_MARK_WIDTH, overflow: 'hidden' }, containerStyle]}>
