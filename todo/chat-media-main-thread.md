...
- `shared/chat/warming.js`
- `shared/chat/warmingconfig.js`
...
Extra pressure comes from iOS media warming and transient render-file tasks. Media warming could continue after a route batch was released, and transient image/file render tasks stayed queued after leaving the chat.
...
- iOS chat warming keeps message-batch preloading enabled but disables background media warming.
