...
That bundle is about 324 Firestore read-equivalent ops, 132 Firestore writes, 26 function invocations, and 1 Storage Class A operation per active user/day. The default send cost assumes active OS-notification routes; no-active-route or bot-heavy traffic is one read cheaper per visible send. At 1M DAU, the default bundle implies about 289 visible messages/s and 1.2 wallet tx/s.
